...
<?php
  ...
  $get_category = $product->show_brand_id($brand_id);
  $res_brand = $get_category->fetch_assoc();
        ...
        <div class="content">
            ...
            <div class="category">
              ...
              <div class="cts2">
                <div class="grid_cts2">
                  <?php
                    $get_product_brand_id = $product->get_product_brand_id($brand_id);
                    if($get_product_brand_id) {
                      while($res_brand = $get_product_brand_id->fetch_assoc()) {
                  ?>
                    <div class="grid_item2">
                        <a href="productDetail.php?product_id=<?php echo $res_brand['product_id']; ?>">
                          <div class="product_img" style="background-image: url(../admin/uploads/<?php echo $res_brand['product_image'] ?>);"></div>
                          <h5 class="product_name"><?php echo $res_brand['product_name'] ?></h5>
                        </a>
                      <div class="product_price">
                        <span class="product_price_present"><?php echo $res_brand['product_price'] ?>đ</span>
                      </div>
                      <div class="product_click">
                        <button class="collection-item-btn product_buy"><a href="cart.php?product_id=<?php echo $res_brand['product_id'] ?>">Mua ngay</a></button>
                      </div>
                    </div>
                  <?php
                      }
